...
class MarketWatchlistAdapter(private val fragment: MarketWatchlistFragment, val mContext: Context, private val arrayList: ArrayList<Market>,
                             private var fontSize: Int, private var textViewWidth: Int, private var ivWidth: Int, private var ivHeight: Int)
    : RecyclerView.Adapter<MarketWatchlistAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v: View? = null
        v = if (language == "en") {
            LayoutInflater.from(parent.context).inflate(R.layout.layout_item_market_watchlist, parent, false)
        } else {
            LayoutInflater.from(parent.context).inflate(R.layout.layout_item_market_watchlist_mirror, parent, false)
        }
        return ViewHolder(v)
    }
